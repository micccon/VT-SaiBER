"""Typed contracts for the runtime lanes."""
...
class MCPServerConfig:
    """One MCP server the runner should connect to directly."""
...
class AgentExecutionSpec(Generic[TOutcome]):
    """Declarative description of one execution-lane agent run."""
...
class ChatSynthesisSpec(Generic[TOutcome]):
    """Declarative description of one non-tool synthesis run."""
...
class ExecutionResult(Generic[TOutcome]):
    """Typed result returned by the execution runner."""
...
class ChatSynthesisResult(Generic[TOutcome]):
    """Typed result returned by the chat/synthesis runner."""
