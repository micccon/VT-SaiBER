"""Tool-less chat/synthesis runner for the promoted runtime."""
...
from src.core.llm_client import create_chat_completion_with_retry, resolve_openrouter_runtime
from src.core.parsers import extract_json_payload
from src.runtime.contracts import ChatSynthesisResult, ChatSynthesisSpec
from src.runtime.tracing import trace_failure, trace_synthesis_result, trace_synthesis_start
