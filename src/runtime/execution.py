"""Execution-lane runtime helpers."""
...
from src.core.parsers import normalize_tool_result, to_jsonable
...
from src.runtime.tracing import trace_execution_result, trace_execution_start, trace_failure
...
class AgentsSDKExecutionRunner:
    """Build and run an execution-lane agent over local and MCP tools."""
