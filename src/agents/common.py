"""Shared helper functions for thin specialist agents."""
...
from src.runtime.contracts import AgentExecutionSpec, MCPServerConfig, ModelConfig

TOutcome = TypeVar("TOutcome")


def build_default_model_config(*, temperature: float = 0.0) -> ModelConfig:
    """Build the standard model configuration for one specialist run."""
...
def build_single_mcp_execution_spec(
    *,
    ...
    """Build the standard single-MCP-server execution spec for a specialist."""
...
def validation_error_update(
    ...
    *,
    ...
    """Return the standard validation error update."""
...
def execution_error_update(
    ...
    *,
    ...
    """Return the standard execution failure update."""
...
async def run_agent_node(
    ...
    """Run one specialist node and persist its state delta."""
