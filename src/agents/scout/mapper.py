...
from src.core.validators import target_in_scope
...
def map_execution_result_to_state(
    ...
    *,
    ...
    """Convert a Scout execution result into CyberState updates."""
    ...
    if not _used_recon_tool(result):
        return _validation_error(
            ...
            message="Scout did not execute a reconnaissance tool.",
        )
