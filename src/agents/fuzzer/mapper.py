...
from src.core.agent_parsers import dedupe_web_findings
from src.agents.fuzzer.constants import MAX_RECURSION_DEPTH, REQUEST_THROTTLE_MS
...
def map_execution_result_to_state(
    ...
    *,
    ...
    """Convert a Fuzzer execution result into CyberState updates."""
        ...
        return {
            ...
            "errors": [
                AgentError(
                    ...
                    error="Fuzzer did not execute a web enumeration tool.",
                    recoverable=True,
                )
            ],
        }
