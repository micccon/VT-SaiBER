"""Lean CyberState mapping for resident v2 execution results."""
...
from src.v2.agents.resident.constants import RESIDENT_OBJECTIVE_STATUSES
from src.v2.agents.resident.context import resolve_objective
...
def map_execution_result_to_state(
    ...
    *,
    ...
    """Convert a resident v2 execution result into compact CyberState updates."""
