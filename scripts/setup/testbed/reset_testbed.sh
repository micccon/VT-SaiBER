...
#
# Usage:
#   bash scripts/setup/testbed/reset_testbed.sh          # stop container only
#   bash scripts/setup/testbed/reset_testbed.sh --clean  # stop + remove built image
...
if [ "$CLEAN" = true ]; then
    ...
    info "To also remove the image: bash scripts/setup/testbed/reset_testbed.sh --clean"
fi
...
echo ""
echo "  To restart: bash scripts/setup/testbed/setup_testbed.sh"
echo "============================================================"
