...
#
# Usage:
#   bash scripts/setup/testbed/start_testbed.sh
#
# Prerequisites:
...
echo ""
echo "  Run validate:  bash scripts/setup/testbed/validate_testbed.sh"
echo "  Run reset:     bash scripts/setup/testbed/reset_testbed.sh"
echo "  Full setup:    bash scripts/setup/testbed/setup_testbed.sh  (rebuilds image)"
echo "============================================================"
