#!/bin/bash
# scripts/setup/docker/startup.sh - Start all containers without rebuilding
...
# Use this for normal startups. For a full reset and rebuild, use scripts/setup/docker/full_reset_startup.sh
